...
import { Star, GitFork, GitPullRequest, AlertCircle, Zap, Github } from "lucide-react"
            ...
            !loading && (
              <div className="bg-neutral-100 dark:bg-neutral-800 rounded-2xl p-12 text-center">
                ...
                <p className="text-neutral-600 dark:text-neutral-400">
                  Enter GitHub usernames above and click "Rank" to see detailed analytics and comparisons.
                </p>
              </div>
            )
          )}
